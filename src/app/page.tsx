  ...
  return (
    <MaxWidthWrapper className="mb-12 mt-28 sm:mt-40 flex flex-col items-center justify-center text-center">
      ...
      <p className="mt-5 max-w-prose text-zinc-700 sm:text-lg">
        Quill allows you to chat with your PDF documents in real-time. It's a simpler form of studying your documents. Simply upload yout file and start asking questions right away.
      </p>
